...
const teacherNavigation = [
  ...
  { name: "Questions", href: "/teacher/questions", icon: Brain },
...
export function TeacherSidebar() {
  ...
  const [collapsed, setCollapsed] = useState(() => {
    if (typeof window !== "undefined") {
      const savedCollapsed = localStorage.getItem("teacher-sidebar-collapsed");
  ...
  useEffect(() => {
    localStorage.setItem("teacher-sidebar-collapsed", collapsed.toString());
  }, [collapsed]);
